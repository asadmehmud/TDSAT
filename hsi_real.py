...
if __name__ == "__main__":
    ...
    # Artificial
    mat_dataset = MatDataFromFolder('/kaggle/input/hsi-denoising-artificial-dataset-mat-files', fns=['avcup97refcomb_smaller_coloredSigmaSImin4Times1Same_datamat3D.mat'])
