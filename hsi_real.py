...
if __name__ == "__main__":
    ...
    # Artificial
    mat_dataset = MatDataFromFolder('/kaggle/input/hsi-denoising-artificial-dataset-mat-files', fns=['avcup97refcomb_coloredSigmaSImin4Times10Same_datamat3D_small.mat'])
