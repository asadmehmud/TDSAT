...
if __name__ == "__main__":
    ...
    # Artificial
    mat_dataset = MatDataFromFolder('/kaggle/input/hsi-denoising-artificial-dataset-mat-files', fns=['avcup97refcomb_smaller_coloredSigmaSIp4min5Times10Diff_datamat3D.mat'])
